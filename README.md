...
- 当前版本：`v0.3.6-dev.1`
- 当前定位：内部开发版，重点修正应用图标资产、赠送重置公开 seed 口径、设置页单列布局和刷新历史独立页面。
...
- 展示 Codex 赠送重置次数，支持查看每次重置的观测获取时间、预计过期时间和保守提醒时间；桌面端显式启用 `2026-06-11` 与 `2026-06-30` 两个公开发放 seed，未匹配到公开 seed 或后续新增观测的首次已有次数才显示为无法反推。
