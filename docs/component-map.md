...
| 顶部四卡 | `MetricCard` | 可复用 | `label`、`value`、`detail`、`badge`、`icon`、`tone` | `snapshot.overview`、`snapshot.overview.previous` |
...
- 顶部四卡必须显示自定义指标图标，不使用官方 OpenAI / Codex 视觉资产。
