...
- Codex 用量、额度周期和 reset 检测共享逻辑来自远程 Git 依赖 `@lifeinhand/codex-usage-core@0.1.0-dev.1`，固定到 `gooderno1/codex-usage-core#v0.1.0-dev.1`；本项目负责把核心包输出映射为 `DashboardSnapshot`、总览页和账本页字段。
