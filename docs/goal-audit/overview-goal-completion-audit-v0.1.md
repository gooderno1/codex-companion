...
- 5H 周期：`2026-06-03T19:55:38.000Z` 到 `2026-06-04T00:55:38.000Z`
- 5H Token：`114547`
- 5H 观测证据：`observations=2`、`resetCount=0`
- 周额度周期：`2026-06-02T13:18:53.000Z` 到 `2026-06-09T13:18:53.000Z`
- 周额度 Token：`161041014`
- 周额度观测证据：`observations=1138`、`resetCount=0`
- 周额度圆环：最近原始余量 `99%`
