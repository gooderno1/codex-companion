const designTokenVariables = {
  "--bg-canvas": "#f8fbff",
  "--bg-veil": "rgba(255, 255, 255, 0.97)",
  "--surface-primary": "rgba(255, 255, 255, 0.97)",
  "--surface-strong": "#ffffff",
  "--surface-muted": "rgba(248, 251, 255, 0.88)",
  "--line-soft": "rgba(15, 111, 255, 0.10)",
  "--line-strong": "rgba(15, 111, 255, 0.18)",
  "--text-primary": "#111827",
  ...
  "--accent-rose": "#dc2626",
  "--accent-green": "#16a34a",
  "--shadow-soft": "0 8px 22px rgba(15, 23, 42, 0.035)",
  "--shadow-strong": "0 12px 28px rgba(15, 23, 42, 0.045)",
  "--radius-shell": "18px",
  "--radius-panel": "18px",
  "--radius-card": "18px",
  "--radius-pill": "999px",
