const designTokenVariables = {
  "--bg-canvas": "#f8fbff",
  "--bg-veil": "rgba(255, 255, 255, 0.98)",
  "--surface-primary": "rgba(255, 255, 255, 0.98)",
  "--surface-strong": "#ffffff",
  "--surface-muted": "rgba(248, 251, 255, 0.82)",
  ...
  "--accent-rose": "#dc2626",
  "--accent-green": "#16a34a",
  "--shadow-soft": "0 8px 20px rgba(15, 111, 255, 0.045)",
  "--shadow-strong": "0 10px 26px rgba(15, 111, 255, 0.05)",
  "--radius-shell": "18px",
  "--radius-panel": "18px",
  "--radius-card": "18px",
  "--radius-pill": "999px",
